...
\begin{document}
    ...
    \begin{description}
        ...
        \DescribeEnv{paramobject} There's also the \texttt{paramobject} environment, which takes the \meta{name} of the object as argument and defines for every field name a corresponding command.
